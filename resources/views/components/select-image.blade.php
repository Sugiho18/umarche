...
<div class="modal micromodal-slide" id="{{ $modal }}" aria-hidden="true">
  ...
  <a data-micromodal-trigger="{{ $modal }}" class="bg-gray-200 border-0 py-2 px-8 focus:outline-none hover:bg-gray-600 rounded text-lg" href='javascript:;'>ファイルを選択</a>
