                ...
                <div class="md:flex md:justify-around">
                    ...
                    <div class="md:w-1/2 ml-4">
                        ...
                        <div class="flex justify-around items-center">
                            ...
                            <div class="relative">
                              <select class="rounded border appearance-none border-gray-300 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-200 focus:border-indigo-500 text-base pl-3 pr-10 mr-8">
                                <option>SM</option>
                                <option>M</option>
                                <option>L</option>
                                <option>XL</option>
                ...
                <div class="border-t border-gray-400 my-8"></div> 
                    ...
                    <div class="mb-4 text-center">
                       ...
                       @else 
                        <img src=""> 
                       @endif 
                    <button data-micromodal-trigger="modal-1" type="button"class="text-white bg-gray-500 border-0 py-2 px-6 focus:outline-none hover:bg-gray-600 rounded" href='javascript:;' >店舗情報</button>
                </div>
            </div>
        </div>
    </div>
