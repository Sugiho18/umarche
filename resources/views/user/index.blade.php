                    ...
                    <div class="lg:flex lg:justify-around">
                        <div class="lg:flex items-center"> 
                            ...
                            <div class="flex space-x-2 items-center"> 
                                <div><input name="keyword" placeholder="キーワードを入力"></div> 
                                <div><button class="text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">
                                    検索する</button></div> 
                            </div> 
                        </div>
                        <div class="flex">
